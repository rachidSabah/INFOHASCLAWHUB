...
export function GitIntelligencePanel({ open, onOpenChange }: GitIntelligencePanelProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-5xl max-h-[92vh] p-0 gap-0 overflow-hidden flex flex-col overflow-hidden overflow-hidden flex flex-col">
        ...
        <Tabs defaultValue="commit" className="flex flex-col flex-1 min-h-0">
          ...
          {/* ──────── COMMIT MESSAGES TAB ──────── */}
          <TabsContent value="commit" className="flex-1 min-h-0 mt-0 overflow-y-auto">
          ...
          {/* ──────── PR REVIEW TAB ──────── */}
          <TabsContent value="review" className="flex-1 min-h-0 mt-0 overflow-y-auto">
            <ScrollArea className="h-[calc(90vh-14rem)]">
              <div className="p-6 space-y-5">
                {/* Input section */}
                <div className="rounded-lg border bg-card p-4 space-y-4">
          ...
          <TabsContent value="conflict" className="flex-1 min-h-0 mt-0 overflow-y-auto">
            <ScrollArea className="h-[calc(90vh-14rem)]">
              <div className="p-6 space-y-5">
                <div className="rounded-lg border bg-card p-4 space-y-4">
                  <h4 className="font-semibold text-sm flex items-center gap-2">
